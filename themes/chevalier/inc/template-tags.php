...
if ( ! function_exists( 'chevalier_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function chevalier_posted_on() {
...
if ( ! function_exists( 'chevalier_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function chevalier_posted_by() {
...
if ( ! function_exists( 'chevalier_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function chevalier_entry_footer() {
...
if ( ! function_exists( 'chevalier_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function chevalier_post_thumbnail() {
...
if ( ! function_exists( 'chevalier_fil_ariane' ) ) :
	/**
	* Affiche le fil d'ariane.
	*/
	function chevalier_fil_ariane($tax='') {
		...
		if(!is_front_page()) :
			...
			if ( 'post' === get_post_type() ) :
				...
				$actus=chevalier_get_page_ID('page_actualites'); // ID traduit si besoin
				if($actus) :
					printf('<a href="%s">%s</a> > ',
			...
			if ( is_tax() ) :
				...
				if('produits_conventionnels'==$tax) :
					$page=chevalier_get_page_ID('page_produits_conventionnels');
				elseif ('produits_bio'==$tax) :
					$page=chevalier_get_page_ID('page_produits_bio');
				endif;
				if($page) :
					printf('<a href="%s">%s</a> > ',
